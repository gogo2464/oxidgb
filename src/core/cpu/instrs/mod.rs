...
pub fn execute_instruction(cpu : &mut CPU, instr : u16, origin : u16) -> u8 {
    return match instr & 0xFF {
        ...
        0x8D => adc_l(cpu),
        0x8F => adc_a(cpu),
        0x90 => sub(cpu.regs.b, cpu),
        0x91 => sub(cpu.regs.c, cpu),
        0x92 => sub(cpu.regs.d, cpu),
        0x93 => sub(cpu.regs.e, cpu),
        0x94 => sub(cpu.regs.h, cpu),
        0x95 => sub(cpu.regs.l, cpu),
        0x97 => sub(cpu.regs.a, cpu),
        0x98 => sbc_b(cpu),
        0x99 => sbc_c(cpu),
        0x9A => sbc_d(cpu),
        0x9B => sbc_e(cpu),
